    ...
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#291b24] text-gray-300">
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#291b24] flex flex-col justify-center items-center"
        }
      >
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]">
            <a
              className="flex justify-between items-center w-full text-[#333333]"
              href="jitka-moreira-web-dev.pdf"
              download="jitka-moreira-web-dev.pdf"
            >
